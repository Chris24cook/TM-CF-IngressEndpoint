...
# Basic info about the container environment
@app.route('/')
def index():
    return jsonify({
        "status": "online",
...
# Inspect headers to see network route/proxies (Azure Load Balancer, etc.)
...
# Simulate a heavier load or processing time
...
# Traceroute to a target (if available)
...
if __name__ == '__main__':
    ...
    print(f"Starting Network Probe Agent on port {port}")
